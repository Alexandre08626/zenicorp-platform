...
function makePage(slug, titleLine, nameVar) {
...
const targets = [
  { slug: 'asphalte', file: 'src/app/asphalte/page.tsx' },
  { slug: 'toiture', file: 'src/app/toiture/page.tsx' },
  { slug: 'isolation', file: 'src/app/isolation/page.tsx' },
];

targets.forEach((t) => {
  const content = makePage(t.slug, '', t.slug);
