        ...
        <div className="container-zenicorp">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              { title: 'Planification', desc: 'Évaluation énergétique, visitez sur site, prix ferme, calendrier des travaux.', step: 2 },
      ...
      <section id="faq" className="section-padding bg-white">
        <div className="container-zenicorp max-w-3xl">
          ...
          <dl className="space-y-4">
            {[
              { q: 'Combien coûte une isolation ?', a: 'La cellulose au grenier coûte environ 1,50-2 $/pi² et le polyuréthane giclé 3-5 $/pi². Le dépôt de 305 $ réserve votre projet.' },
              { q: 'Y a-t-il des subventions ?', a: 'Oui. Nous vous accompagnons avec les programmes Rénoclimat et autres subventions gouvernementales. Notre équipe gère les documents.' },
              { q: 'Combien de temps ça prend ?', a: 'Un grenier se fait généralement en une journée. Les murs en polyuréthane prennent 1-2 jours.' },
