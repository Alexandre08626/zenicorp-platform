      ...
      <section id="faq" className="section-padding bg-white">
        <div className="container-zenicorp max-w-3xl">
          ...
          <dl className="space-y-4">
            {[
              { q: 'Combien coûte une toiture ?', a: 'Un bardeau d\'asphalte coûte environ 8-12 $/pi² installé, selon la pente et la complexité. Le dépôt de 305 $ réserve votre projet.' },
              { q: 'Combien de temps ça prend ?', a: 'Une toiture résidentielle standard se remplace en 1 à 3 jours selon la grandeur et la météo.' },
              { q: 'Faites-vous les urgences de fuite ?', a: 'Oui, réparation de fuites en urgence 24/7 pour nos clients. Un entrepreneur du réseau est jumelé rapidement.' },
