...
const division = getDivisionBySlug('asphalte')!;
...
export default function AsphaltePage() {
      ...
      <section id="faq" className="section-padding bg-white">
        <div className="container-zenicorp max-w-3xl">
          ...
          <dl className="space-y-4">
            {[
              { q: 'Combien coûte l\'entretien d\'asphalte ?', a: 'Le scellant coûte environ 0,50 $/pi² et la réparation de fissures est facturée au pied linéaire. Le dépôt de 305 $ réserve votre projet.' },
              { q: 'Quand faire mon entretien d\'asphalte ?', a: 'Idéalement au printemps ou à l\'automne, par temps sec avec température au-dessus de 10 °C.' },
              { q: 'Combien de temps ça dure ?', a: 'Un scellant de qualité protège votre asphalte 3 à 5 ans selon la circulation et le climat.' },
